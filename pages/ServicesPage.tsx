              ...
              >
                ...
                <div className="p-10 flex flex-col flex-grow items-center text-center">
                  ...
                  <a
                    ...
                    className="h-16 flex items-center justify-center gap-2 w-full bg-brand-whatsapp text-white rounded-xl font-bold text-base btn-interact shadow-lg shadow-black/10 whitespace-nowrap"
                  >
              ...
              <div className="relative z-10 grid lg:grid-cols-12 gap-8 md:gap-16 items-center">
                <div className="lg:col-span-12 flex flex-col items-center text-center">
                  ...
                  <a
                    ...
                    target="_blank"
                    className="w-full sm:w-auto min-h-[4rem] flex items-center justify-center gap-3 px-6 sm:px-12 bg-brand-whatsapp text-white rounded-xl font-bold text-sm btn-interact shadow-xl shadow-brand-whatsapp/20 hover:scale-[1.05] transition-all duration-300 text-center py-4"
                  >
