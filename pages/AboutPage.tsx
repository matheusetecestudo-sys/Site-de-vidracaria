          ...
          <div className="container-precision text-center reveal active mx-auto">
            ...
            <div className="flex justify-center">
              <a
                ...
                target="_blank"
                className="group h-20 min-w-[300px] flex items-center justify-center gap-4 px-12 bg-gradient-to-r from-brand-accent to-[#B8860B] text-black rounded-2xl font-black text-lg btn-interact shadow-[0_20px_50px_rgba(212,175,55,0.4)] whitespace-nowrap"
              >
