          ...
          <div className="container-precision text-center reveal active mx-auto">
            ...
            <div className="flex justify-center">
              <a
                ...
                target="_blank"
                className="group h-16 min-w-[260px] flex items-center justify-center gap-4 px-6 md:px-10 btn-gold-premium rounded-xl font-bold text-base btn-interact shadow-2xl shadow-black/10 whitespace-nowrap leading-none"
              >
