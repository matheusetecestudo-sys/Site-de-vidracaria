  ...
  return (
    <div className="bg-white min-h-screen font-inter">
      <main className="pt-32 md:pt-32">
        ...
        <header className="py-10 md:py-24 bg-brand-primary text-white overflow-hidden relative">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 pt-16 border-t border-brand-accent/10">
              {values.map((v, i) => (
                <div key={i} className="flex flex-col items-center text-center group p-8 bg-brand-light rounded-3xl transition-all hover:bg-white hover:shadow-2xl border border-transparent hover:border-brand-accent/20 italic">
                  <div className="font-black text-4xl md:text-5xl mb-6 title-gold-premium italic">0{i + 1}</div>
                  <h3 className="text-2xl md:text-3xl font-black mb-6 leading-tight">{v.t}</h3>
          ...
          <div className="container-precision text-center reveal active mx-auto">
            ...
            <div className="flex justify-center">
              <a
                ...
                target="_blank"
                className="group h-14 md:h-16 min-w-[220px] md:min-w-[260px] flex items-center justify-center gap-2 md:gap-4 px-4 md:px-10 btn-gold-premium rounded-xl font-bold text-xs md:text-base btn-interact shadow-2xl shadow-black/10 whitespace-nowrap leading-none"
              >
