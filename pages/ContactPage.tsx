          ...
          <div className="container-precision relative z-10">
            <div className="reveal active flex flex-col items-center text-center">
              <div className="flex items-center justify-center gap-3 mb-8">
                ...
                <span className="text-[10px] font-bold text-brand-accent uppercase tracking-[0.3em]">Consultoria Estratégica</span>
                <span className="w-10 h-[2px] bg-brand-accent"></span>
              </div>
              ...
              <a
                ...
                className="w-full sm:w-auto h-20 md:h-24 flex items-center justify-center gap-4 md:gap-6 px-10 md:px-16 bg-brand-accent text-white rounded-3xl md:rounded-[2.5rem] font-black text-xl md:text-2xl btn-interact shadow-2xl shadow-brand-accent/40 whitespace-nowrap transition-all duration-500 hover:scale-[1.05]"
              >
