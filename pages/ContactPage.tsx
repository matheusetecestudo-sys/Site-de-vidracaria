          ...
          <div className="container-precision relative z-10">
            <div className="reveal active flex flex-col items-center text-center">
              ...
              <a
                ...
                className="w-full sm:w-auto h-20 flex items-center justify-center gap-4 px-8 sm:px-12 btn-gold-premium rounded-[2rem] font-black text-xl btn-interact shadow-2xl shadow-black/10 whitespace-nowrap"
              >
