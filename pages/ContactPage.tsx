  ...
  return (
    <div className="bg-white min-h-screen font-inter">
      <main className="pt-24">
        ...
        {/* --- CONTACT CHANNELS BLOCK (Formatting of Image 4) --- */}
            ...
            <div className="bg-slate-950 rounded-[3rem] p-10 md:p-20 overflow-hidden relative reveal active shadow-3xl">
              ...
              <div className="relative z-10 text-center flex flex-col items-center">
                <div className="flex items-center justify-center gap-4 mb-8">
                  ...
                  <span className="text-[10px] font-bold text-brand-accent uppercase tracking-[0.3em]">Canais de Contato</span>
                  <span className="w-10 h-[2px] bg-brand-accent"></span>
                </div>
                <h2 className="text-4xl md:text-7xl font-black !text-brand-accent mb-12 leading-[1.1] tracking-tight">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 border-t border-white/5 pt-16 w-full items-start">
                  ...
                  <div className="flex flex-col items-center text-center group lg:col-span-1 md:col-span-2 lg:md:col-auto">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                      ...
                      <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Showroom Industrial & Logística</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* --- PREPARATION & MAP BLOCK (Formatting of Image 4) --- */}
        <section className="py-12 md:py-16 bg-white">
          <div className="container-precision">
            <div className="bg-slate-950 rounded-[3rem] p-10 md:p-20 overflow-hidden relative reveal active shadow-3xl">
              <div className="absolute top-0 right-0 w-[40%] h-full bg-brand-accent/5 skew-x-[-15deg] pointer-events-none" />
              ...
              <div className="relative z-10 grid lg:grid-cols-12 gap-16 md:gap-24 items-center">
                <div className="lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left">
                  <div className="flex items-center gap-4 mb-8">
                    <span className="w-10 h-[2px] bg-brand-accent"></span>
                    <span className="text-[10px] font-bold text-brand-accent uppercase tracking-[0.3em]">Logística Própria</span>
                    <span className="w-10 h-[2px] bg-brand-accent lg:hidden"></span>
                  </div>
                  <h2 className="text-4xl md:text-7xl font-black !text-brand-accent mb-10 leading-[1] tracking-tight">
                    O que ter <br /> <span className="text-slate-400 font-medium italic">em mãos?</span>
                  </h2>
                  <div className="grid gap-8 w-full">
                    {[
                      ...
                      { t: "Estética", d: "Cor de perfis e ferragens desejada." }
                    ].map((item, i) => (
                      <div key={i} className="flex gap-6 items-start group">
                        <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex flex-shrink-0 items-center justify-center text-brand-accent font-black text-lg group-hover:bg-brand-accent group-hover:text-white transition-all duration-500">
                          0{i + 1}
                        </div>
                        <div>
                          <h4 className="text-lg font-black !text-white mb-1 uppercase tracking-tight">{item.t}</h4>
                          <p className="text-slate-400 font-medium leading-relaxed text-sm">{item.d}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="lg:col-span-6 relative h-[500px] md:h-[600px] w-full">
                  <div className="absolute inset-0 rounded-[2.5rem] overflow-hidden shadow-3xl border-[8px] border-white/10 group bg-slate-900">
                    <iframe
                      title="Localização Técnica"
                      ...
                      loading="lazy"
                    ></iframe>
                    {/* Dark Overlay on Map Following Image Reference Style */}
                    <div className="absolute bottom-6 left-6 right-6 bg-slate-950/90 backdrop-blur-md p-6 rounded-2xl border border-white/10 text-white z-20 shadow-2xl">
                      <p className="text-[10px] font-bold text-brand-accent uppercase tracking-widest mb-3">Cobertura Técnica</p>
                      <p className="text-lg font-black mb-4 leading-tight">Grande São Paulo e Interior.</p>
                      <div className="flex items-center gap-3">
                        <div className="flex -space-x-2">
                          {[1, 2, 3].map(i => <div key={i} className="w-6 h-6 rounded-full border border-slate-900 bg-slate-800" />)}
                        </div>
                        <span className="text-[8px] font-bold text-slate-500 uppercase tracking-widest">Time Especializado</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        {/* --- BRAND PROMISE BLOCK (Formatting of Image 4) --- */}
        <section className="py-12 md:py-16 bg-white">
          <div className="container-precision">
            <div className="bg-slate-950 rounded-[3rem] p-12 md:p-24 overflow-hidden relative reveal active shadow-2xl">
              ...
              <div className="relative z-10 text-center flex flex-col items-center">
                <div className="flex items-center justify-center gap-4 mb-8">
                  <span className="w-10 h-[2px] bg-brand-accent"></span>
                  <span className="text-[10px] font-bold text-brand-accent uppercase tracking-[0.3em]">Qualidade Duno</span>
                  <span className="w-10 h-[2px] bg-brand-accent"></span>
                </div>

                <h2 className="text-3xl md:text-7xl font-black !text-brand-accent mb-12 leading-[1.1] tracking-tighter">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 border-t border-white/5 pt-12 w-full">
                  {[
                    ...
                    { v: "12 m", l: "Garantia Técnica" },
                    { v: "NBR", l: "Certificação" }
                  ].map((stat, i) => (
