        ...
        <section className="relative pt-8 pb-12 md:pt-24 md:pb-32 bg-brand-light overflow-hidden">
          ...
          <div className="container-precision relative z-10">
            <div className="reveal active flex flex-col items-center text-center">
              ...
              <h1 className="text-4xl md:text-7xl lg:text-[100px] font-black leading-[1] md:leading-[0.85] mb-8 tracking-tighter">
                <span className="bg-gradient-to-b from-[#FFF5D1] via-brand-accent to-[#8B732F] bg-clip-text text-transparent">
              ...
              <a
                ...
                className="w-full sm:w-auto h-20 flex items-center justify-center gap-4 px-10 sm:px-16 bg-gradient-to-r from-brand-accent to-[#B8860B] text-black rounded-[2.5rem] font-black text-xl btn-interact shadow-[0_20px_50px_rgba(212,175,55,0.4)] whitespace-nowrap"
              >
              ...
              <div className="lg:col-span-6 reveal active flex flex-col items-center lg:items-start text-center lg:text-left">
                <div className="space-y-8 w-full">
                  <div className="space-y-6">
                    <h2 className="text-4xl md:text-7xl lg:text-[100px] font-black leading-[0.9] tracking-tighter">
                      <span className="bg-gradient-to-b from-[#FFF5D1] via-brand-accent to-[#8B732F] bg-clip-text text-transparent uppercase">
