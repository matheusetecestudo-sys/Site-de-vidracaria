              ...
              <div className="bg-slate-950 rounded-3xl p-6 md:p-16 text-white relative overflow-hidden shadow-2xl">
                ...
                <div className="space-y-12 mb-12 max-w-2xl mx-auto">
                  <a
                    ...
                    className="group flex flex-col items-center justify-center gap-6 p-10 bg-white/5 rounded-3xl border border-white/5 hover:bg-brand-whatsapp transition-all duration-500 text-center"
                  >
