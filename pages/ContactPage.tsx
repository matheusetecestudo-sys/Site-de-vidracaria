    ...
    <div className="pt-32 pb-24 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16 reveal active">
          <span className="text-[#00966d] font-black text-[10px] sm:text-xs uppercase tracking-[0.4em] mb-4 block">Central de Atendimento</span>
          <h1 className="text-[2.6rem] sm:text-5xl md:text-7xl font-black text-slate-900 mb-6 tracking-tighter leading-[1] sm:leading-[0.9]">
            Orçamento direto <br className="hidden sm:block"/> <span className="text-[#00966d]">via WhatsApp.</span>
          </h1>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            <a 
              href={WHATSAPP_LINK}
              className="relative group bg-[#00966d] rounded-[3.5rem] p-10 shadow-2xl shadow-emerald-600/20 hover:bg-emerald-700 transition-all hover:-translate-y-2 active:scale-95 reveal active"
            >
            ...
            <div className="grid md:grid-cols-2 gap-6 reveal active">
              <div className="bg-slate-50 p-8 rounded-[3rem] border border-slate-100 flex flex-col items-center md:items-start text-center md:text-left h-full">
                <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-[#00966d] shadow-sm mb-6">
          ...
          <div className="lg:col-span-5 reveal active">
            <div className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)] h-full">
              <h4 className="text-2xl font-black text-slate-900 mb-8 tracking-tight flex items-center justify-center md:justify-start gap-4">
                <span className="w-10 h-10 bg-emerald-50 text-[#00966d] rounded-xl flex items-center justify-center text-lg">⚙️</span>
                Checklist Orçamento
              </h4>
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex flex-col md:flex-row items-center md:items-start gap-5 group">
                    <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-[#00966d] group-hover:text-white transition-all shrink-0">
              ...
              <div className="mt-12 p-8 bg-emerald-50/50 rounded-3xl border border-emerald-100/50 text-center">
                 <p className="text-[10px] font-black text-[#00966d] uppercase tracking-[0.2em] mb-3">Qualidade de Usina</p>
