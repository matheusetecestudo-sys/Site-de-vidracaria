  ...
  return (
    <div className="bg-white min-h-screen font-inter overflow-x-hidden">
      <main className="pt-32 md:pt-32">
        ...
        {/* --- HERO SECTION --- */}
        <section className="relative pt-8 pb-12 md:pt-24 md:pb-32 bg-brand-light overflow-hidden">
          ...
          <div className="container-precision relative z-10">
            <div className="reveal active flex flex-col items-center text-center">
              ...
              <h1 className="text-4xl md:text-7xl lg:text-[100px] font-black leading-[1] md:leading-[0.85] mb-8 tracking-tight title-gold-premium">
                Canais de <br className="hidden md:block" />
                <span className="font-normal whitespace-nowrap">Comunicação.</span>
              </h1>
              ...
              <a
                ...
                className="w-full sm:w-auto h-16 md:h-20 flex items-center justify-center gap-3 md:gap-4 px-6 md:px-12 btn-gold-premium rounded-[2rem] font-black text-sm md:text-xl btn-interact shadow-2xl shadow-black/10 whitespace-nowrap"
              >
        ...
        <section className="py-8 md:py-12 bg-white">
          <div className="container-precision">
            <div className="bg-brand-primary rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-20 overflow-hidden relative reveal active shadow-3xl">
              <div className="absolute top-0 right-0 w-[40%] h-full bg-brand-accent/5 skew-x-[-15deg] pointer-events-none" />

              <div className="relative z-10 text-center flex flex-col items-center">

                <h2 className="text-4xl md:text-7xl font-black mb-12 leading-[1.05] tracking-tight uppercase title-gold-premium">
                  Sede <br className="hidden md:block" />
                  <span className="font-normal">Corporativa.</span>
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 border-t border-white/5 pt-16 w-full items-start">
                  ...
                  <div className="flex flex-col items-center text-center group">
                    ...
                    <p className="text-[10px] font-bold !text-brand-light/40 uppercase tracking-[0.1em] mt-2">Segunda a Sábado</p>
                  </div>
        ...
        {/* --- PREPARATION BLOCK --- */}
        <section id="preparacao" className="py-12 md:py-20 bg-white overflow-hidden border-t border-brand-light">
          <div className="container-precision">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 lg:gap-24 items-center">
              ...
              <div className="lg:col-span-6 reveal active flex flex-col items-center lg:items-start text-center lg:text-left">
                <div className="space-y-8 w-full">
                  <div className="space-y-6">
                    <h2 className="text-4xl md:text-7xl lg:text-[85px] font-black leading-[0.9] tracking-tighter title-gold-premium">
                      O que ter <br className="hidden md:block" />
                      <span className="font-normal">em mãos?</span>
                    </h2>
                  ...
                  <div className="space-y-10 pt-4">
                    {[
                      ...
                      <div key={i} className="flex flex-col sm:flex-row items-center sm:items-start gap-6 group text-center sm:text-left">
                        <div className="w-14 h-14 rounded-2xl bg-white border-2 border-brand-accent/10 flex flex-shrink-0 items-center justify-center shadow-lg transition-all duration-500">
                          <span className="font-black text-xl title-gold-premium">0{i + 1}</span>
                        </div>
                        <div className="pt-2">
                          <h4 className="text-xl font-black text-brand-primary mb-2 uppercase tracking-tight leading-none">{item.t}</h4>
                          <p className="text-brand-secondary/70 font-medium leading-relaxed max-w-sm sm:max-w-none">{item.d}</p>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="lg:col-span-6 reveal active relative w-full">
                <div className="relative rounded-[3rem] md:rounded-[4rem] overflow-hidden shadow-3xl shadow-brand-primary/10 border-[10px] md:border-[16px] border-white ring-1 ring-brand-accent/10 group h-[500px] md:h-[750px] w-full bg-brand-light">
                  <iframe
                  ...
                  <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-auto md:right-10 bg-white/95 backdrop-blur shadow-2xl p-6 md:p-8 rounded-2xl md:rounded-3xl border border-brand-accent/10 text-brand-primary z-20 md:max-w-xs transition-transform duration-500 group-hover:translate-y--2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] font-black text-brand-accent/60 uppercase tracking-widest">Atendimento Especializado</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-10 md:py-24 bg-white">
          <div className="container-precision">
            <div className="bg-brand-primary rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-24 overflow-hidden relative reveal active shadow-2xl">
              <div className="absolute top-0 left-0 w-[40%] h-full bg-brand-accent/5 skew-x-[15deg] pointer-events-none" />

              <div className="relative z-10 text-center flex flex-col items-center">


                <h2 className="text-3xl md:text-7xl font-black mb-12 leading-[1.1] tracking-tighter uppercase max-w-4xl title-gold-premium">
                  Paz de Espírito <br className="hidden md:block" />
                  <span className="font-normal">Estrutural.</span>
                </h2>
