      ...
      <div className="container-precision">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
          {galleryServices.map((service, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end items-center text-center p-4 pb-8 md:pb-10">
                <p className="!text-white font-black text-[10px] md:text-sm uppercase tracking-[0.2em] leading-tight mb-4 drop-shadow-2xl min-h-[2.5rem] flex items-center justify-center">
                  {service.title}
                </p>
                <div className="flex items-center justify-center gap-2 btn-gold-premium text-black text-[10px] md:text-[11px] font-bold px-4 md:px-6 py-3 rounded-xl transition-all duration-500 opacity-100 md:opacity-0 md:group-hover:opacity-100 shadow-xl whitespace-nowrap scale-90 md:scale-100 leading-none">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="reveal active flex flex-col items-center justify-center aspect-square rounded-[2rem] btn-gold-premium p-8 text-center group transition-all duration-500 shadow-2xl relative overflow-hidden btn-interact"
          >
