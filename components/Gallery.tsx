          ...
          {galleryServices.map((service, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end items-center text-center p-4 pb-8 md:pb-10">
                ...
                <div className="flex items-center justify-center gap-2 btn-gold-premium text-black text-[10px] md:text-[11px] font-bold px-6 py-3 rounded-xl transition-all duration-500 opacity-100 md:opacity-0 md:group-hover:opacity-100 shadow-xl whitespace-nowrap scale-90 md:scale-100">
