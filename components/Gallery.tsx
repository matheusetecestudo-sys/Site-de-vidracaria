          ...
          {galleryServices.map((service, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end items-center text-center p-4 pb-8 md:pb-10">
                <p className="!text-white font-black text-[10px] md:text-sm uppercase tracking-[0.2em] leading-tight mb-4 drop-shadow-2xl">{service.title}</p>
                <div className="inline-flex items-center gap-2 btn-gold-premium text-black text-[10px] md:text-[11px] font-bold px-4 py-2.5 rounded-xl transition-all duration-500 opacity-100 md:opacity-0 md:group-hover:opacity-100 shadow-xl whitespace-nowrap scale-90 md:scale-100">
