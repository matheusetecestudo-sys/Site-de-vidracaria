      ...
      <div className="container-precision">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
          {galleryServices.map((service, index) => (
            ...
            >
              <img
                ...
                decoding="async"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-brand-primary/95 via-brand-primary/60 to-transparent opacity-85 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="absolute inset-0 flex flex-col justify-end items-center text-center p-4 pb-8 md:pb-10">
                ...
                <div className="inline-flex items-center gap-2 bg-brand-accent text-black text-[10px] md:text-[11px] font-bold px-4 py-2.5 rounded-xl transition-all duration-500 opacity-100 md:opacity-0 md:group-hover:opacity-100 shadow-xl whitespace-nowrap scale-90 md:scale-100">
          ...
          >
            ...
            <p className="text-black font-bold text-[11px] uppercase tracking-[0.2em] leading-relaxed">Peça seu orçamento no WhatsApp</p>
          </a>
        </div>
      </div>
    </section>
