    ...
    <section id="solucoes" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 reveal active">
          <span className="text-blue-600 font-black text-[10px] uppercase tracking-[0.4em] mb-4 block">Catálogo Completo</span>
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 tracking-tighter">Nossas <span className="text-blue-600 italic">Soluções.</span></h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/20 to-transparent opacity-100">
                <div className="absolute bottom-0 left-0 p-5 md:p-6 w-full text-center md:text-left">
                  ...
                  <div className="inline-block bg-blue-600 text-white text-[8px] font-black px-3 py-1.5 rounded-full uppercase tracking-tighter shadow-lg transform translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all">
                    ORÇAR NO WHATSAPP
                  </div>
                </div>
              </div>
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="reveal active flex flex-col items-center justify-center aspect-square rounded-[2rem] bg-blue-600 p-6 text-center group hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20"
          >
