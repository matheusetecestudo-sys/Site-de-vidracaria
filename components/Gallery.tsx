      ...
      <div className="container-precision">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="reveal active flex flex-col items-center justify-center aspect-square rounded-[2rem] bg-brand-secondary p-8 text-center group transition-all duration-500 shadow-2xl relative overflow-hidden btn-interact"
          >
