        ...
        <div className="mt-16 reveal active border-t border-white/5 pt-16">
          <div className="flex flex-col items-center text-center gap-12">
            ...
            <a
              ...
              className="h-16 w-full sm:w-auto flex items-center justify-center gap-3 px-10 btn-gold-premium text-black rounded-xl font-bold text-base btn-interact shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap"
            >
