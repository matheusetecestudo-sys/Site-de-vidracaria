      ...
      <div className="container-precision relative z-10">
        <header className="mb-10 md:mb-10 md:mb-16 reveal active text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-black !text-brand-accent tracking-tight leading-[1] mb-8">
            Do Projeto à <br />
            <span className="text-brand-accent font-normal">Entrega Final.</span>
          </h2>
          ...
          {steps.map((step, index) => (
            <div key={index} className="reveal active group flex flex-col items-center text-center">
              <div className="flex flex-col items-center gap-6 mb-10 w-full">
                <span className="text-6xl font-black title-gold-premium group-hover:scale-110 transition-all duration-500 italic leading-tight">
                  {step.num}
                </span>
        ...
        <div className="mt-16 reveal active border-t border-white/5 pt-16">
          <div className="flex flex-col items-center text-center gap-12">
            <div className="text-center">
              ...
              <p className="!text-brand-light font-medium">Fale agora com nosso time técnico profissional.</p>
            </div>
            <a
              href={getWhatsAppLink("Início", "Seção Processo/Metodologia")}
              target="_blank"
              rel="noopener noreferrer"
              className="h-16 w-full sm:w-auto flex items-center justify-center gap-3 px-6 md:px-12 btn-gold-premium text-black rounded-2xl font-bold text-[11px] md:text-base btn-interact shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap leading-none"
            >
