    ...
    <section className="py-24 bg-slate-950 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16 reveal active">
          <span className="text-blue-400 font-black text-xs uppercase tracking-[0.4em] mb-4 block">Como Trabalhamos</span>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {steps.map((step, index) => (
            <div key={index} className="relative z-10 reveal active text-center group">
              <div className="bg-slate-900 border border-blue-500/20 w-20 h-20 rounded-2xl flex items-center justify-center text-blue-400 mb-8 mx-auto transition-all group-hover:bg-blue-600 group-hover:text-white">
        ...
        <div className="mt-16 text-center reveal active">
           <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-4 px-12 py-6 bg-blue-600 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl active:scale-95">
              {CTA_TEXT}
           </a>
        </div>
      </div>
