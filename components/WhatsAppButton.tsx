    ...
    <div className={`fixed bottom-6 right-6 z-[100] transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <a
          ...
          className="w-16 h-16 bg-brand-accent rounded-2xl flex items-center justify-center text-black shadow-2xl shadow-brand-accent/40 relative group active:scale-95 transition-all outline-none touch-manipulation focus:ring-4 focus:ring-brand-accent/20"
