            ...
            <div className="lg:col-span-12 relative flex justify-center">
              <div className="relative bg-brand-secondary ring-1 ring-white/10 backdrop-blur-3xl p-6 md:p-8 lg:p-14 rounded-3xl shadow-2xl max-w-2xl w-full">
                ...
                <a
                  ...
                  className="w-full h-16 flex items-center justify-center gap-4 btn-gold-premium rounded-xl font-bold text-base btn-interact shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap leading-none"
                >
