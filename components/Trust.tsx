          ...
          <div className="relative z-10 grid lg:grid-cols-12 gap-4 md:gap-16 md:gap-24 items-center">
            <div className="lg:col-span-12 text-center flex flex-col items-center">
              ...
              <h2 className="text-4xl md:text-7xl font-black !text-brand-accent mb-10 leading-[1] tracking-tight">
                O Padrão <br /> <span className="text-brand-accent font-normal whitespace-nowrap">de Excelência.</span>
              </h2>
            ...
            <div className="lg:col-span-12 relative flex justify-center">
              <div className="relative bg-brand-secondary ring-1 ring-white/10 backdrop-blur-3xl p-6 md:p-8 lg:p-14 rounded-3xl shadow-2xl max-w-2xl w-full">
                <div className="flex flex-col items-center text-center gap-6 mb-8">
                  ...
                  <div>
                    <h3 className="text-xl font-bold !text-brand-accent tracking-tight leading-none mb-1">Análise Técnica</h3>
                ...
                <a
                  ...
                  className="w-full h-16 flex items-center justify-center gap-3 bg-brand-whatsapp text-white rounded-xl font-bold text-base btn-interact shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap"
                >
