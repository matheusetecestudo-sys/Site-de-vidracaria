  ...
  return (
    <section id="sobre" className="py-10 md:py-12 bg-white relative font-inter">
      <div className="container-precision">
        <div className="bg-brand-primary rounded-3xl p-6 lg:p-16 overflow-hidden relative reveal active shadow-2xl">
          ...
          <div className="relative z-10 grid lg:grid-cols-12 gap-4 md:gap-16 md:gap-24 items-center">
            <div className="lg:col-span-12 text-center flex flex-col items-center">
              ...
              <h2 className="text-4xl md:text-7xl font-black mb-10 leading-[1] tracking-tight title-gold-premium">
                O Padrão <br /> <span className="font-normal whitespace-nowrap">de Excelência.</span>
              </h2>
            ...
            <div className="lg:col-span-12 relative flex justify-center">
              <div className="relative bg-brand-secondary ring-1 ring-white/10 backdrop-blur-3xl p-6 md:p-8 lg:p-14 rounded-3xl shadow-2xl max-w-2xl w-full">
                <div className="flex flex-col items-center text-center gap-6 mb-8">
                  <div className="w-16 h-16 btn-gold-premium rounded-2xl flex items-center justify-center text-black shadow-lg">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold tracking-tight leading-none mb-1 title-gold-premium !inline-block">Análise Técnica</h3>
                    <p className="!text-white/60 text-[10px] font-bold uppercase tracking-widest">Consultoria Gratuita</p>
                  </div>
                </div>
                <p className="!text-brand-light mb-10 font-medium text-base leading-relaxed text-center">
                ...
                <a
                  ...
                  className="w-full h-14 md:h-16 flex items-center justify-center gap-2 md:gap-4 px-4 md:px-10 btn-gold-premium rounded-xl font-bold text-xs md:text-base btn-interact shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap leading-none"
                >
