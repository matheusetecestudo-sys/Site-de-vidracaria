          ...
          <div className="relative z-10 grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7">
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-[10px] font-bold text-blue-500 uppercase tracking-[0.3em]">Credibilidade Técnica</span>
              </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative bg-slate-900 ring-1 ring-white/10 backdrop-blur-3xl p-10 lg:p-14 rounded-[3rem] shadow-2xl">
                ...
                <a
                  ...
                  className="w-full h-14 flex items-center justify-center bg-emerald-500 text-white rounded-xl font-bold text-xs btn-interact shadow-lg shadow-emerald-500/20"
                >
