      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-900 rounded-[3.5rem] p-10 lg:p-20 overflow-hidden relative reveal active">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <span className="text-blue-400 font-black text-xs uppercase tracking-[0.4em] mb-6 block">Por que confiar na Cristal?</span>
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8 leading-[0.95] tracking-tighter">
                Excelência em <br/> <span className="text-blue-400 italic">engenharia técnica.</span>
              </h2>
              <p className="text-blue-100/70 font-medium text-lg mb-12 leading-relaxed max-w-lg">
            ...
            <div className="bg-white/5 backdrop-blur-2xl p-10 lg:p-14 rounded-[3rem] border border-white/10 shadow-2xl">
              <div className="flex items-center gap-4 mb-8">
                 <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(16,185,129,0.4)]">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                 </div>
                 <h3 className="text-2xl font-black text-white">Consultoria Técnica</h3>
              </div>
              <p className="text-blue-100/60 mb-10 font-medium text-sm">
              ...
              <a 
                ...
                className="group flex items-center justify-center gap-4 w-full py-6 bg-blue-600 text-white font-black text-sm rounded-2xl hover:bg-blue-700 transition-all shadow-2xl shadow-blue-600/30 hover:-translate-y-1 active:scale-95 uppercase tracking-widest"
              >
