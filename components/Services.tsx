              ...
              >
                ...
                <div className="p-8 md:p-12 flex flex-col flex-grow items-center text-center">
                  ...
                  <a
                    ...
                    className="w-full sm:w-auto h-16 flex items-center justify-center gap-3 px-10 bg-brand-whatsapp hover:bg-[#059669] text-white rounded-xl font-bold text-base btn-interact shadow-lg shadow-brand-whatsapp/20 hover:shadow-xl hover:shadow-brand-whatsapp/30 hover:scale-[1.02] transition-all duration-300 whitespace-nowrap"
                  >
