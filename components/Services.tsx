          ...
          <div className="lg:col-span-12">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="group flex items-center gap-4 py-4 px-2 border-b-2 border-brand-accent/20 text-[11px] font-bold text-brand-primary hover:text-brand-accent hover:border-brand-accent transition-all duration-300"
              >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 md:gap-12">
            {FEATURED_SERVICES.map((service, index) => (
              <div
                key={service.id}
                className="reveal active group flex flex-col bg-white rounded-[2.5rem] border-2 border-brand-accent/10 hover:shadow-[0_40px_80px_-16px_rgba(0,28,68,0.15)] transition-all duration-700 btn-interact shadow-lg"
              >
                ...
                <div className="p-8 md:p-12 flex flex-col flex-grow items-center text-center">
                  <div className="flex flex-col items-center gap-4 mb-6">
                    <span className="text-2xl font-black group-hover:scale-110 transition-transform italic leading-tight title-gold-premium">0{index + 1}</span>
                  ...
                  <a
                    ...
                    className="w-full sm:w-auto h-16 flex items-center justify-center gap-3 px-6 md:px-10 btn-gold-premium rounded-xl font-bold text-sm md:text-base btn-interact shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-black/20 hover:scale-[1.02] transition-all duration-300 whitespace-nowrap leading-none"
                  >
          ...
          <div className="mt-12 flex justify-center reveal active">
            <div className="inline-flex items-center gap-6 px-10 h-16 bg-brand-primary text-white rounded-2xl shadow-2xl">
              <div className="flex -space-x-3">
                {[
                  ...
                  <div key={i} className="w-8 h-8 rounded-full border-2 border-brand-primary bg-brand-primary overflow-hidden">
