        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 md:gap-12">
            {FEATURED_SERVICES.map((service, index) => (
              <div
                key={service.id}
                className="reveal active group flex flex-col bg-white rounded-[2.5rem] overflow-hidden border-2 border-brand-accent/10 hover:shadow-[0_40px_80px_-16px_rgba(0,28,68,0.15)] transition-all duration-700 btn-interact shadow-lg"
              >
                ...
                <div className="p-8 md:p-12 flex flex-col flex-grow items-center text-center">
                  ...
                  <a
                    ...
                    className="w-full sm:w-auto h-16 flex items-center justify-center gap-3 px-10 bg-brand-whatsapp hover:bg-brand-whatsapp/90 text-white rounded-xl font-bold text-base btn-interact shadow-lg shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.02] transition-all duration-300 whitespace-nowrap"
                  >
