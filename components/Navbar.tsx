        ...
        <div className="container-precision flex justify-between items-center gap-2 md:gap-4 h-16">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <a
              ...
              className="hidden md:flex items-center justify-center gap-2 px-3 md:px-8 h-10 md:h-12 btn-gold-premium text-black rounded-xl font-bold text-[10px] md:text-sm btn-interact shadow-xl shadow-black/20 focus:outline-none whitespace-nowrap leading-none"
            >
            ...
            <button
              ...
              className="md:hidden w-10 h-10 flex items-center justify-center bg-black/50 backdrop-blur-md rounded-xl border border-brand-accent/20 shadow-sm z-[110] relative focus:outline-none touch-manipulation"
