        ...
        <div className="container-precision flex justify-between items-center px-4 md:px-6 h-12 md:h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 px-8 h-12 btn-gold-premium text-black rounded-xl font-bold text-sm btn-interact shadow-xl shadow-black/20 focus:outline-none whitespace-nowrap leading-none"
            >
