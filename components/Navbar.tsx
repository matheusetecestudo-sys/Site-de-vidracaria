  ...
  return (
    <>
      <header className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ${scrolled ? 'bg-black/95 backdrop-blur-xl py-3 shadow-2xl' : 'py-4 md:py-6 bg-black/80 backdrop-blur-sm'
        ...
        <div className="container-precision flex justify-between items-center px-4 md:px-6 h-12 md:h-20">
          ...
          >
            <img
              ...
              alt="Duno Vidraçaria"
              className="h-10 md:h-18 w-auto object-contain transition-all duration-500"
            />
          </button>

          {/* Grupo da Direita (Navegação + Botão Orçamento + Botão Menu) */}
          <div className="flex items-center gap-4 md:gap-8">
            ...
            {/* Botão Orçamento Desktop - Oculto no Mobile */}
            <a
              href={getWhatsAppLink("Navbar", "Orçamento Rápido")}
              target="_blank"
              rel="noopener noreferrer"
              className="hidden md:flex items-center justify-center gap-2 px-8 h-12 btn-gold-premium text-black rounded-xl font-bold text-sm btn-interact shadow-xl shadow-black/20 focus:outline-none whitespace-nowrap leading-none"
            >
