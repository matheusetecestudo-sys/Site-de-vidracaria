  ...
  return (
    <>
      <header className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 ${scrolled ? 'bg-black/95 backdrop-blur-xl py-4 shadow-2xl' : 'py-4 md:py-8 bg-black/80 backdrop-blur-sm'
        ...
        <div className="container-precision flex justify-between items-center gap-2 md:gap-4 h-16">

          <button
            onClick={() => window.location.href = '/'}
            className="flex items-center group focus:outline-none h-full"
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <a
              ...
              className="flex items-center justify-center gap-2 px-3 md:px-8 h-10 md:h-12 btn-gold-premium text-black rounded-xl font-bold text-[10px] md:text-sm btn-interact shadow-xl shadow-black/20 focus:outline-none whitespace-nowrap leading-none"
            >
            ...
            <button
              ...
              className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-black/50 backdrop-blur-md rounded-xl md:rounded-2xl border border-brand-accent/20 shadow-sm z-[110] relative focus:outline-none touch-manipulation"
