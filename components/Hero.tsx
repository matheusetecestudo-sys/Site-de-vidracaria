          ...
          <div className="lg:col-span-12 reveal active text-center flex flex-col items-center">
            ...
            <div className="flex flex-col items-center justify-center gap-8 md:gap-10 w-full">
              <a
                ...
                className="w-full sm:w-auto h-20 flex items-center justify-center gap-4 px-6 sm:px-12 btn-gold-premium rounded-[2rem] font-black text-xl btn-interact shadow-2xl shadow-black/10 whitespace-nowrap leading-none"
              >
