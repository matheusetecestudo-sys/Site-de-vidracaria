        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="reveal active text-center lg:text-left">
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-slate-900 leading-[1] mb-6 tracking-tighter">
              Vidros com <br />
              Instalação <br />
              <span className="text-blue-600">Rápida.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href={WHATSAPP_LINK}
                className="inline-flex items-center justify-center gap-3 px-10 py-6 text-base font-black text-white bg-blue-600 rounded-2xl shadow-xl shadow-blue-600/30 hover:bg-blue-700 transition-all hover:scale-105 active:scale-95 uppercase tracking-wide"
              >
                {CTA_TEXT}
