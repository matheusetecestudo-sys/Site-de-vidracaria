          ...
          <div className="lg:col-span-7 reveal active">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8">
              <a
                ...
                className="w-full sm:w-auto h-[64px] flex items-center justify-center px-10 bg-emerald-500 text-white rounded-2xl font-bold text-sm btn-interact shadow-xl shadow-emerald-500/20"
              >
          ...
          <div className="lg:col-span-5 relative reveal active hidden lg:block">
            <div className="relative z-10 rounded-[3rem] overflow-hidden aspect-[4/5] shadow-2xl border-[12px] border-white">
              ...
              <div className="absolute inset-x-8 bottom-8 p-8 bg-white/90 backdrop-blur-md rounded-3xl shadow-xl flex items-center gap-6">
                ...
                <div>
                  <p className="text-[10px] font-bold text-blue-600 uppercase tracking-widest mb-1">Certificado de Segurança</p>
