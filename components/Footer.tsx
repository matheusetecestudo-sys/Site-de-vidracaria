            ...
            <div className="space-y-6 flex flex-col items-center">
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="h-14 flex items-center justify-center gap-3 px-10 bg-brand-secondary hover:bg-brand-accent text-white rounded-2xl font-bold text-sm btn-interact shadow-2xl shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.05] transition-all duration-300 whitespace-nowrap"
                >
