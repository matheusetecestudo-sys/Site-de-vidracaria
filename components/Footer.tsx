  ...
  return (
    <footer className="bg-brand-primary text-white pt-12 pb-32 md:pb-12 border-t border-white/5 font-inter">
      <div className="container-precision">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-12 md:mb-20 text-center lg:text-left items-start">
              ...
              {mainServices.map((s) => (
                <li key={s.id}>
                  <a
                    ...
                    target="_blank"
                    className="text-base hover:text-brand-accent transition-colors font-medium !text-white opacity-80 hover:opacity-100"
                  >
                    {s.title}
                  </a>
                </li>
          ...
          <div className="space-y-8 flex flex-col items-center lg:items-start">
            ...
            <ul className="space-y-4">
              ...
              <li><button onClick={() => onNavigate?.('contato')} className="text-base hover:text-brand-accent transition-colors font-medium !text-white opacity-80 hover:opacity-100">Fale com um técnico</button></li>
            </ul>
          </div>
            ...
            <div className="space-y-6 flex flex-col items-center lg:items-start">
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="h-16 w-full max-w-[280px] md:max-w-none flex items-center justify-center gap-3 px-4 md:px-10 btn-gold-premium text-black rounded-2xl font-bold text-[10px] md:text-sm btn-interact shadow-2xl shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.05] transition-all duration-300 leading-none whitespace-nowrap"
                >
        ...
        {/* Bottom Bar */}
        <div className="pt-12 border-t border-brand-accent/10 flex flex-col items-center gap-8 text-center">
          <p className="text-[11px] font-medium !text-brand-light/40">
