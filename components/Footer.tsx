            ...
            <div className="space-y-6 flex flex-col items-center lg:items-start">
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="h-16 w-full max-w-[300px] md:max-w-none flex items-center justify-center gap-3 px-6 btn-gold-premium text-black rounded-2xl font-bold text-xs md:text-base btn-interact shadow-2xl shadow-black/20 hover:shadow-xl hover:shadow-black/30 hover:scale-[1.05] transition-all duration-300 leading-none whitespace-nowrap"
                >
